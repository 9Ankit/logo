(function (global, factory) {
	...
	typeof define === 'function' && define.amd ? define('neutrinos-module', ['exports', '@angular/core', '@angular/common/http', 'neutrinos-seed-services', '@angular/material', 'signature_pad', '@angular/common', '@angular/forms', '@angular/platform-browser/animations', '@angular/flex-layout', 'n-sheet', '@angular/material/icon', '@angular/material/dialog', '@angular/material/button'], factory) :
	(factory((global['neutrinos-module'] = {}),global.ng.core,global.ng.common.http,global['neutrinos-seed-services'],global.ng.material,global.signature_pad,global.ng.common,global.ng.forms,global.ng.platformBrowser.animations,global.ng['flex-layout'],global['n-sheet'],global.ng.material.icon,global.ng.material.dialog,global.ng.material.button));
}(this, (function (exports,core,http,neutrinosSeedServices,material,signing__default,common,forms,animations,flexLayout,nSheet,icon,dialog,button) { 'use strict';
...
var NFileIOService = /** @class */ (function () {
    function NFileIOService(http$$1) {
        var _this = this;
        this.http = http$$1;
...
var NAlertService = /** @class */ (function () {
    function NAlertService(dialog$$1) {
...
NSignatureComponent.propDecorators = {
    "signaturecanvas": [{ type: core.ViewChild, args: ['signaturecanvas',] },],
    "canvasparent": [{ type: core.ViewChild, args: ['canvasparent',] },],
